...
const UpdateProfileModel = ({ setisOpenModel,profile }) => {
    ...
    return (
        <>
            ...
            <div className="fixed z-50 border-4 border-black border-solid b-g-white sm:min-h-[400px] bg-white  text-black sm:w-[600px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl p-4 w-[320px] min-h-[420px]">
